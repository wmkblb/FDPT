...
def extend_cfg(cfg):
    ...
    # Config for Frequency-Decoupled Prompt Tuning (FDPT)
    cfg.TRAINER.FDPT = CN()
    cfg.TRAINER.FDPT.N_CTX = 16
    cfg.TRAINER.FDPT.CTX_INIT = "a photo of a"
    cfg.TRAINER.FDPT.PREC = "fp16"
    cfg.TRAINER.FDPT.PROMPT_DEPTH = 12
    cfg.TRAINER.FDPT.TEACHER_NAME = "ViT-B/16"
    cfg.TRAINER.FDPT.LAMBD = 12.0
    cfg.TRAINER.FDPT.LAMBDA_LOW = 0.1
    cfg.TRAINER.FDPT.LAMBDA_HIGH = 0.1
    cfg.TRAINER.FDPT.USE_PROMPT_SPLIT = True
    cfg.TRAINER.FDPT.USE_ROUTING = True
    cfg.TRAINER.FDPT.FREQ_LAYER = 6
    cfg.TRAINER.FDPT.FREQ_KERNEL = 5
    cfg.TRAINER.FDPT.USE_HIGH_FILTER = True
    cfg.TRAINER.FDPT.HIGH_FILTER_TAU = 1.0
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new
